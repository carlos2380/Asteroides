...
/**
 * Created by carlos on 27/06/2016.
 */
public class AlmacenPuntuacionesFicheroExtApi implements AlmacenPuntuaciones {

    private static String FICHERO = "Android/data/com.example.asteroides/files/puntuaciones.txt";
    private Context context;

    public AlmacenPuntuacionesFicheroExtApi(Context context) {
